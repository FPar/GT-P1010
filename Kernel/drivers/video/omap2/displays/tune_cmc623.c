...
static DEVICE_ATTR(mdnieset_ui_file_cmd, S_IRUGO|S_IWUSR, mdnieset_ui_file_cmd_show, mdnieset_ui_file_cmd_store);
...
static DEVICE_ATTR(mdnieset_outdoor_file_cmd, S_IRUGO|S_IWUSR, mdnieset_outdoor_file_cmd_show, mdnieset_outdoor_file_cmd_store);
...
static DEVICE_ATTR(mdnieset_region_file_cmd, S_IRUGO|S_IWUSR, mdnieset_region_file_cmd_show, mdnieset_region_file_cmd_store);
...
static DEVICE_ATTR(color_white, S_IRUGO|S_IWUSR, color_white_show, color_white_store);
...
static DEVICE_ATTR(color_black, S_IRUGO|S_IWUSR, color_black_show, color_black_store);
...
static DEVICE_ATTR(color_saturation, S_IRUGO|S_IWUSR, color_saturation_show, color_saturation_store);
...
static DEVICE_ATTR(lightsensor_file_state, S_IRUGO|S_IWUSR, lightsensor_file_state_show, lightsensor_file_state_store);
...
static DEVICE_ATTR(cabcset_file_cmd, S_IRUGO|S_IWUSR, cabcset_file_cmd_show, cabcset_file_cmd_store);
...
static DEVICE_ATTR(lcdtype, S_IRUGO|S_IWUSR, lcdtype_show, lcdtype_store);
...
static DEVICE_ATTR(lcdid_adc, S_IRUGO|S_IWUSR, lcdid_adc_show, lcdid_adc_store);
...
static DEVICE_ATTR(lcd_power, S_IRUGO|S_IWUSR,control_lcd_power_show,	control_lcd_power_store);
...
static int __devinit cmc623_probe(struct omap_dss_device *dssdev)
{
	...
	if (gpio_request(OMAP_GPIO_LVDS_EN, "lvds_en") < 0) {
		printk(KERN_ERR "\n FAILED TO REQUEST GPIO %d for LVDS \n", OMAP_GPIO_LVDS_EN);
		return;
	}
	gpio_direction_output(OMAP_GPIO_LVDS_EN, 1);
