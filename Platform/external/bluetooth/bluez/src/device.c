...
// BEGIN SS_BLUEZ_BT +kjh 2011.03.16 : changed DISCOVERY_TIMER
// 2sec is too short, It can make race condition if bonding is started by remote.
//#define DISCOVERY_TIMER		2
#define DISCOVERY_TIMER		5
// END SS_BLUEZ_BT
